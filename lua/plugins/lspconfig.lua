...
-- blink.cmp and friends are loaded on demand on first InsertEnter.
pack.register({
...
vim.api.nvim_create_autocmd("InsertEnter", {
    group = vim.api.nvim_create_augroup("my_config_blink", { clear = true }),
    once = true,
    callback = function()
        pack.load({ "LuaSnip", "friendly-snippets", "blink-copilot", "blink.cmp" })
